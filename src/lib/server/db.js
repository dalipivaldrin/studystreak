/**
 * MongoDB-Anbindung mit Connection-Caching fuer Serverless-Umgebungen.
...
/** User-spezifische Faecher/Module */
export async function getModules() {
  const db = await getDb();
  return db.collection('modules');
}

/** Robustes ObjectId-Parsing (gibt null bei ungueltigter ID statt zu werfen). */
